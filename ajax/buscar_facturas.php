<?php
	...
	if($action == 'ajax'){
		...
		if ( $_GET['q'] != "" )
		{
		$sWhere.= " and  (clientes.nombre_cliente like '%$q%' or facturas.numero_factura like '%$q%' or facturas.estado_factura like '%$q%')";
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						if ($estado_factura==1){$text_estado="Entregado";$label_class='label-success';}
						else{$text_estado="En proceso";$label_class='label-warning';}
